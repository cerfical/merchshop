...
func (_m *TokenGen) NewToken(u *model.User) (auth.Token, error) {
	ret := _m.Called(u)
	...
	var r0 auth.Token
	var r1 error
	if rf, ok := ret.Get(0).(func(*model.User) (auth.Token, error)); ok {
		return rf(u)
	}
	if rf, ok := ret.Get(0).(func(*model.User) auth.Token); ok {
		r0 = rf(u)
	} else {
...
func (_c *TokenGen_NewToken_Call) Return(_a0 auth.Token, _a1 error) *TokenGen_NewToken_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *TokenGen_NewToken_Call) RunAndReturn(run func(*model.User) (auth.Token, error)) *TokenGen_NewToken_Call {
	_c.Call.Return(run)
	return _c
}
